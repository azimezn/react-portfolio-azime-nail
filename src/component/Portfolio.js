        ...
        <Row>
          <Col>
            <section className="new-project">
              ...
              <a href="https://soup-or-sandwich.herokuapp.com/" target="_blank" rel="noreferrer"><img class="project-screenshots" src={souporsandwichScreenshot} alt="screenshot of the game Soup or Sandwich" /></a>
            </section>
          </Col>
        </Row>
        <Row>
          <Col class="old-project">
            ...
            <a href="https://jennahopeclem.github.io/monthly-planner/" target="_blank" rel="noreferrer"><img class="project-screenshots" src={monthlyCalendarScreenshot} alt="screenshot of the monthly planner" /></a>
          </Col>
          ...
          <Col class="old-project">
            ...
            <a href="https://azimezn.github.io/azime-nail-portfolio/" target="_blank" rel="noreferrer"><img class="project-screenshots" src={portfolioScreenshot} alt="Azime Nail's portfolio" /></a>
          </Col>
          <Col class="old-project">
            <h3>Pre-Work Study Guide </h3>
            <p>My very first attempt in coding for the bootcamp I attended by Rutgers University.</p>
            <a href="https://azimezn.github.io/prework-study-guide/" target="_blank" rel="noreferrer"><img class="project-screenshots" src={preworkScreenshot} alt="screenshot of my prework study guide" /></a>
          </Col>
        </Row>
      </Container>
    </div>
